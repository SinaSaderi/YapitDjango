...
class HTMXPropertyListView(generic.ListView):
...
class HTMXPropertyCreateView(generic.CreateView):
    model = models.Property
    form_class = forms.PropertyForm
...
class HTMXPropertyDeleteView(generic.DeleteView):
    model = models.Property
    success_url = reverse_lazy("Property_Property_htmx_list")
