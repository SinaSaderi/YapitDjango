...
class HTMXClientListView(generic.ListView):
    model = models.Client
...
class HTMXClientCreateView(generic.CreateView):
    model = models.Client
    form_class = forms.ClientForm
...
class HTMXClientDeleteView(generic.DeleteView):
    model = models.Client
    success_url = reverse_lazy("Client_Client_htmx_list")
