...
class HTMXSampleModelListView(generic.ListView):
...
class HTMXSampleModelCreateView(generic.CreateView):
    model = models.SampleModel
    form_class = forms.SampleModelForm
...
class HTMXSampleModelDeleteView(generic.DeleteView):
    model = models.SampleModel
    success_url = reverse_lazy("SampleModel_SampleModel_htmx_list")
